...
class MyGrid(Widget):
    ...
    def btn_reset(self):
        entries = str(current_time) + ',' + '1' + ',' + self.time1.text + ',' + self.title1.text + '\n' + \
                  str(current_time) + ',' + '2' + ',' + self.time2.text + ',' + self.title2.text + '\n' + \
                  str(current_time) + ',' + '3' + ',' + self.time3.text + ',' + self.title3.text
        self.time1.text = "0"
        self.time2.text = "0"
        self.time3.text = "0"
        self.title1.text = ""
